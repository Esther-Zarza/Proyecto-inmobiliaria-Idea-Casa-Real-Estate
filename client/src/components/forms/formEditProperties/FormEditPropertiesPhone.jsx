...
import './formEditPropertiesPhone.css';
import { useDebounce } from '../../../assets/hooks/useDebounce';
import { CardEditPropertyPhone } from '../../Card/cardEditProperty/CardEditPropertyPhone';

const FormEditPropertiesPhone = () => {
  ...
  return (
    <div className='mobile-view-edit-properties'>
      <Form className="form-edit-properties-phone d-flex  flex-column gap-3 p-1 text-white" onSubmit={handleFilter}>
        ...
        <Row sm={2} className='mb-4'>
          <Col sm={12} className="d-flex gap-5">
      ...
      <div className="edit-properties-phone  d-flex flex-column gap-3 ">
        {properties.length > 0 ? (
          properties?.map((elem) => {
            return (
              <CardEditPropertyPhone
          ...
          <p className="error-filter">
            No hay propiedades que coincidan con los filtros introducidos
          </p>
        )}
      </div>
...
export default FormEditPropertiesPhone;
