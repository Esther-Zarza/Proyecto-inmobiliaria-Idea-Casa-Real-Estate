...
import { CardEditAppraisal } from '../../Card/cardEditAppraisal/CardEditAppraisal';
import { Container, Form } from 'react-bootstrap';
import './FormEditAppraisals.css'

export const FormEditAppraisals = () => {
  ...
  return (
    <div className="computer-view">
      <section className='section-editAppraisals'>
