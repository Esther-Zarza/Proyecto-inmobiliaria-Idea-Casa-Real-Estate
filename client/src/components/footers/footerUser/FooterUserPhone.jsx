...
import './footerUserPhone.css';

export const FooterUserPhone = () => {
  ...
  return (
    <footer className="footerPhoneUser pt-5">
      <Row xl={2}>
        <Col xl={12} className="d-flex justify-content-center gap-5">
          ...
          <Col xl={6} className="d-flex flex-column gap-2 ">
            ...
            <Link to="user/#formcontacto" className="link">
              Contacto
            </Link>
          </Col>
        </Col>
      ...
      <div className="footer-logo-phone py-4 d-flex  flex-column justify-content-center align-items-center">
        <img
          ...
          onClick={() => navigate('/')}
        />
        <div className="mt-2">© Copyright 2025 All rights reserved</div>
      </div>
    </footer>
  );
};
