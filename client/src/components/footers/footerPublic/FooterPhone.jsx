...
export const FooterPhone = () => {
  ...
  return (
    <footer className="footerPhone pt-4">
      <Row xl={2}>
        <Col xl={12} className="d-flex justify-content-center gap-5">
          ...
          <Col xl={6} className="d-flex flex-column gap-2 ">
            ...
            <a href="/inmuebles" className="link">
              Inmuebles
            </a>
            <Link to="/addAssessment" className="link">Valora tu inmueble</Link>
           
            <Link to="/#formcontacto" className="link">
              Contacto
            </Link> 
          </Col>
        </Col>
