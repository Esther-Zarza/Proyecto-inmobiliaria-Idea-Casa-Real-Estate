...
export const addEstateSchema = z.object({
  ...
  description: z
    .string()
    .regex(/^[\s\S]{6,5000}$/, {
      message: 'La descripción debe tener al menos 6 caracteres y un máximo de 5.000',
    })
    .optional(),
  ...
  ibi: z
    .number({
      message:
        'El IBI ha de ser un número positivo, con máximo de 9 enteros y 2 decimales',
    })
    .nonnegative('El precio debe ser positivo')
  ...
  catastral_reference: z
    .string()
    .regex(/^$|^[0-9A-Z]{20}$/, {
      message: 'La referencia catastral debe tener 20 caracteres alfanuméricos',
    })
  ...
  property_type: z
    .number({ message: 'Se debe seleccionar un tipo' })
    .int()
  ...
  private_observations: z
    .string()
    .max(200, {
      message: 'Las observaciones privadas no pueden superar 200 caracteres',
    })
    .optional(),
});
